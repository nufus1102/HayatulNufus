<nav class="navbar navbar-expand navbar-dark bg-secondary sticky-top">
    <div class="container-lg">
        <a class="navbar-brand" href="."><i class="bi bi-cup-hot"></i> HN_Kuliner</a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#Modalubahpassword"><i class="bi bi-key"></i></i></i> Ubah Password </a></li>
