...
<nav class="navbar navbar-expand sticky-top" style="background-color: #FFFAD7;">
    <div class="container-lg">
        <a class="navbar-brand" href="index.php?x=home"><img src="assets/img/triyuli.png" style="width: 70px;" alt=""> <b>TRIYULI </b></a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-2">
                        ...
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#ModalPassword"><i class="bi bi-key-fill <button class=" btn btn-info btn-sm me-1></i> Ubah Password</a></li>
